...
@section('content')
    ...
    <div class="mb-6 flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-slate-100">
        ...
        <div class="flex items-center gap-3">
            <span class="text-sm font-semibold text-slate-500">Status Dokumen:</span>
            ...
            @else
                <span class="px-3 py-1 bg-yellow-100 text-yellow-700 font-bold rounded-md text-sm">⚠ Draft (Menunggu Review)</span>
            @endif
        </div>
        ...
        <div class="flex items-center gap-3">
            ...
            {{-- Tombol Cetak (Hanya aktif jika sudah di-Accept) --}}
    ...
    <div id="print-area" class="max-w-[800px] mx-auto bg-white p-12 shadow-2xl border border-gray-300 min-h-[1122px]">
        
        <!-- KOP SURAT -->
        <div class="flex items-center gap-6 border-b-4 border-double border-[#1E293B] pb-6 mb-8">
            ...
            <div>
                ...
                <p class="text-lg text-[#1E293B]">Kabupaten Penukal Abab Lematang Ilir (PALI)</p>
                <p class="text-sm text-[#64748B]">Sistem Informasi Geografis Menggunakan K-Means Clustering</p>
            </div>
        </div>

        <!-- TEKS PENGANTAR -->
        <div class="mb-8 text-justify text-[#1E293B] leading-relaxed">
            <p class="mb-4">Berdasarkan hasil pemrosesan data menggunakan algoritma Machine Learning (K-Means Clustering) terhadap 8 indikator kesejahteraan sosial pada 71 desa/kelurahan di Kabupaten Penukal Abab Lematang Ilir (PALI), telah diperoleh pemetaan wilayah yang terbagi menjadi 3 tingkatan klaster: Sejahtera, Berkembang, dan Perlu Perhatian.</p>
            <p>Laporan ini disusun secara otomatis oleh sistem sebagai landasan pengambilan keputusan strategis bagi Pemerintah Daerah. Tujuannya agar alokasi bantuan sosial dan program pengentasan kemiskinan dapat dilakukan secara presisi dan tepat sasaran. Berikut adalah ringkasan sebaran tingkat kesejahteraan tingkat kecamatan berdasarkan proses <em>Bottom-Up Aggregation</em>:</p>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border border-gray-300 px-4 py-2 font-bold 
                        ...
                        {{ $kec->status_akhir ?? 'Belum Diproses' }}
                    </td>
                </tr>
                @endforeach
            </tbody>
        ...
        <div class="flex justify-end mt-16">
            <div class="text-center w-64">
                <p class="mb-1 text-[#1E293B]">Talang Ubi, {{ date('d F Y') }}</p>
