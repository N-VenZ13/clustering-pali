...
<div class="mb-6 flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-slate-100">
    ...
    <div class="flex items-center gap-3">
        ...
        <!-- Alpine State untuk Buka/Tutup Input Catatan Penolakan -->
    ...
    <div class="mb-6 relative z-10 break-inside-avoid">
        ...
        <table class="w-full text-sm border-collapse border border-gray-200">
            <tbody>
                ...
                $label = '-'; $warna = '';
                if($klaster == 1) { $label = 'Sejahtera'; $warna = 'text-green-600'; }
                elseif($klaster == 2) { $label = 'Berkembang'; $warna = 'text-yellow-600'; }
                ...
                @empty
                <tr>
                    <td colspan="2" class="py-2 px-4 text-slate-400 italic">Belum ada data desa terinput.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
