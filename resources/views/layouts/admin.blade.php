    ...
    <div x-data="{ sidebarOpen: true }" class="min-h-screen flex">
        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="bg-[#1E3A8A] text-white flex flex-col shadow-xl z-20 hidden md:flex transition-all duration-300">
            ...
            <nav class="flex-1 px-3 py-6 space-y-2 overflow-hidden">
                <!-- Menu Dashboard -->
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-3 rounded-lg bg-white/10 text-white font-medium hover:bg-white/20 transition group" title="Dashboard">
                ...
                <!-- Menu Data Wilayah -->
                <a href="{{ route('wilayah.index') }}" class="flex items-center gap-3 px-3 py-3 rounded-lg text-[#CBD5E1] hover:bg-white/5 hover:text-white transition group" title="Data Wilayah">
                    <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Menu Laporan -->
                <a href="{{ route('laporan.index') }}" class="flex items-center gap-3 px-3 py-3 rounded-lg text-[#CBD5E1] hover:bg-white/5 hover:text-white transition group" title="Laporan">
                    <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
